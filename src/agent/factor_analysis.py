...
TRAINING_DATA = "C:/Users/ande7/Workspace/databricks-ilec/ilec_pipeline/src/agent/df_train.parquet"
MODEL_FORMULA = " ~ cr(Attained_Age, df=4, lower_bound=18, upper_bound=90 )*Smoker_Status*Sex + Face_Amount_Band*Sex + Face_Amount_Band * Smoker_Status - 1"
...
# do not modify this function, take it as given
...
def check_factor_analysis() -> bool:
    ...
    model_pred_factors = glmnet.predict(
        model_spec.get_model_matrix(df_train)
    )
    ...
    return bool(np.allclose(df_with_factors["model_pred"], model_pred_factors, rtol=1e-10, atol=1e-10))

if __name__ == "__main__":
    print(check_factor_analysis())